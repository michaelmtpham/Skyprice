...
use crate::player_helper::{get_current_news, get_player_info, get_basic_info, get_accessory_bag_storage, get_currencies, get_easter, get_fairy_souls, get_copper, get_player_auction_history};
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .manage(bazaar_cache)
        .invoke_handler(tauri::generate_handler![get_bazaar_price, get_collections, get_current_news, get_player_info, get_hypixel_items, get_skills, get_bingo, get_election_mayor, untrimmed_uuid, trimmed_uuid, get_basic_info, get_accessory_bag_storage, get_currencies, get_easter, get_fairy_souls, get_copper, get_player_auction_history])
